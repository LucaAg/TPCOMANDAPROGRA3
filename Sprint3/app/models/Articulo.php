...
class Articulo
{
    ...
    public function crearArticulo()
    {
        ...
        $consulta->bindValue(':nombreArticulo', $this->nombreArticulo, PDO::PARAM_STR);       
    ...
    public function crearArticuloId()
    {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("INSERT INTO backuparticulos (id,nombreArticulo, precio, cargoEmpleado)
         VALUES (:id,:nombreArticulo, :precio, :cargoEmpleado)");
    ...
    public static function borrarDatosTablaBackUpArticulos()
    {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("TRUNCATE TABLE backuparticulos");
        $consulta->execute();
